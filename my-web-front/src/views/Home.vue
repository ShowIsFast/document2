  ...
  <div>
            ...
            <div class="shortcut">
              <ul class="fl">
                ...
                <li v-if="username == '' || username == null" class="f-item">
                  <span>
                    请<a
                      href="http://localhost:8443/cas/login?service=http://localhost:8080/"
                    >
                      登录</a>
                  </span>
                  <span>
              ...
              <div class="fr typelist">
                <ul class="types">
                  <li v-if="username" class="f-item">
                    <span><a :href="orderUrl">我的订单</a></span>
                  </li>
                  <li class="f-item">
                    <span><a
                      href="http://localhost:9104/cart.html"
                    >我的购物车</a></span>
                  </li>
        ...
        <div class="yui3-g NavList">
              ...
              <div class="all-sort-list2">
                ...
                >
                  ...
                  <div class="item-list clearfix">
                    <div class="subitem">
                      <dl
                        v-for="(itemChild, idx) in item.menus"
                        :key="idx"
                        class="fore"
                      >
                        <dt>
                        ...
                        <dd>
                          <em
                            v-for="(itemChild2, i) in itemChild.menus"
                            :key="i"
                          >
                            <a
                              href="javascript:void(0);"
                              @click="goSearch(itemChild2.name)"
                            >{{ itemChild2.name }}</a>
                          </em>
                        </dd>
                      </dl>
          ...
          <div class="yui3-u Center navArea">
            <ul class="nav">
              ...
              <li class="f-item">
                <a
                  href="http://localhost:9105/seckill-index.html"
                  target="_blank"
                >秒杀</a>
              </li>
            </ul>
    ...
    <div class="py-container">
      <div class="yui3-g SortList">
        <div class="yui3-u Center banerArea">
          ...
          >
            <ol class="carousel-indicators">
              <li
                v-for="(img, index) in lbt"
                :key="index"
                data-target="#cmyCarousel"
                :data-slide-to="index"
        ...
        <div class="yui3-u Right">
          <div class="news">
            <h4>
              <em class="fl">商城快报</em><span class="fr tip">更多 ></span>
            </h4>
            <div class="clearix" />
          ...
          <ul class="yui3-g Lifeservice">
            <li class="yui3-u-1-4 life-item tab-item">
              <i class="list-item list-item-1" />
              <span class="service-intro">话费</span>
            </li>
            <li class="yui3-u-1-4 life-item tab-item">
              <i class="list-item list-item-2" />
              <span class="service-intro">机票</span>
            </li>
            <li class="yui3-u-1-4 life-item tab-item">
              <i class="list-item list-item-3" />
              <span class="service-intro">电影票</span>
            </li>
            <li class="yui3-u-1-4 life-item tab-item">
              <i class="list-item list-item-4" />
              <span class="service-intro">游戏</span>
            </li>
            <li class="yui3-u-1-4 life-item notab-item">
              <i class="list-item list-item-5" />
              <span class="service-intro">彩票</span>
            </li>
            <li class="yui3-u-1-4 life-item notab-item">
              <i class="list-item list-item-6" />
              <span class="service-intro">加油站</span>
            </li>
            <li class="yui3-u-1-4 life-item notab-item">
              <i class="list-item list-item-7" />
              <span class="service-intro">酒店</span>
            </li>
            <li class="yui3-u-1-4 life-item notab-item">
              <i class="list-item list-item-8" />
              <span class="service-intro">火车票</span>
            </li>
            <li class="yui3-u-1-4 life-item notab-item">
              <i class="list-item list-item-9" />
              <span class="service-intro">众筹</span>
            </li>
            <li class="yui3-u-1-4 life-item notab-item">
              <i class="list-item list-item-10" />
              <span class="service-intro">理财</span>
            </li>
            <li class="yui3-u-1-4 life-item notab-item">
              <i class="list-item list-item-11" />
              <span class="service-intro">礼品卡</span>
            </li>
            <li class="yui3-u-1-4 life-item notab-item">
              <i class="list-item list-item-12" />
      ...
      <div class="content">
        <ul>
          <li style="display: block">
            <div class="img-item">
              <p class="tab-pic">
                <span><a href="#"><img src="../assets/img/1.jpg"></a></span>
              </p>
              <div class="tab-info">
          ...
          <li>
            <div class="img-item">
              <p class="tab-pic">
                <span><a href="#"><img src="../assets/img/2.jpg"></a></span>
              </p>
              <div class="tab-info">
                <div class="info-title">
                  <span><a
    ...
    <div class="like">
      <div class="py-container">
        ...
        <div class="bd">
          <ul id="picLBxxl" class="clearfix yui3-g Favourate picLB">
            <li class="yui3-u-1-6">
                ...
                >
                  <ol class="carousel-indicators">
                    <li
                      ...
                      class="active"
                    />
                    <li data-target="#floorCarousel" data-slide-to="1" />
                    <li data-target="#floorCarousel" data-slide-to="2" />
                  </ol>
                  <div class="carousel-inner">
                ...
                >
                  <ol class="carousel-indicators">
                    <li
                      ...
                      class="active"
                    />
                    <li data-target="#floorCarousell" data-slide-to="1" />
                    <li data-target="#floorCarousell" data-slide-to="2" />
                  </ol>
                  <div class="carousel-inner">
                    <div class="active item">
                      <img src="../assets/img/floor-1-b01.png">
          ...
          <div class="toolbar-panels J-panel">
            ...
            >
              <h3 class="tbar-panel-header J-panel-header">
                <a href="" class="title"><i /><em class="title">购物车</em></a>
                <span
...
export default {
  ...
  computed: {
    orderUrl() {
      const url = 'http://localhost:9103/user/findOrder'
      return this.username ? `${url}?username=${this.username}` : url
    }
  },
  created() {
    const t = this.getUrlVal()['ticket']
    if (t) {
      const ticket = t.slice(0, -2)
      sessionStorage.setItem('ticket', ticket)
      window.location.href = 'http://localhost:9103/user/username'
    }
    ...
    if (ticket) {
      axios({
        method: 'get',
        url: 'http://localhost:9103/login/username',
        headers: {
          ticket
        }
      }).then((response) => {
    ...
    axios.get('index').then((res) => {
      ...
      if (data.state === 1) {
        // 商品分类
        this.categoryList = data.content.categoryList
        // 广告轮播图
        this.lbt = data.content.lbt
        // 商品菜单
        this.navList = data.content.indexCategoryList
  ...
  methods: {
    logout() {
      ...
      window.location.href =
        'http://localhost:8080/cas/logout?service=http://localhost:8080/'
    },
    goSearch(name) {
      if (!this.username) {
        window.location.href = 'http://localhost:8443/cas/login?service=http://localhost:8080/'
        return
      }
...
<style scoped>
.all-sort-list2 > .item:hover .item-list {
  display: block;
}
