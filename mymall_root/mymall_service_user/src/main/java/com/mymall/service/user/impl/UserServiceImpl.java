...
import com.mymall.service.user.dao.UserMapper;
...
public class UserServiceImpl implements UserService {
    ...
    public Map<String,Object> selectNewByOne() {
        return userMapper.selectNewByOne();
    }

    @Override
    public List<Map<String,Object>> categoryUser() {
        return userMapper.categoryUser();
    }
    ...
    public void sendSms(String phone) {
        ...
        //异步发送消
        logger.info("发送短信对应的消息：{}",JSON.toJSONString(map));
        rocketMQTemplate.syncSend("quene-sms",JSON.toJSONString(map));
    }
